...
namespace u2.Core.Contract
{
    public interface IMapper
    {
        ...
        Task<object> ToAsync(IContent content, Type type, object value = null, IMapDefer defer = null);
        ...
        Task<T> ToAsync<T>(IContent content, T value = null, IMapDefer defer = null) where T : class, new();
        ...
        /// <returns></returns>
        Task<IEnumerable<T>> ToAsync<T, TP>(IEnumerable<IContent> contents, IEnumerable<T> values = null, Func<T, TP> matchProp = null, string matchAlias = null, IMapDefer defer = null)
            where T : class, new();

        Task<IEnumerable<T>> ToAsync<T>(IEnumerable<IContent> contents, IMapDefer defer = null)
            where T : class, new();

        Task<IEnumerable<object>> ToAsync(Type type, IEnumerable<IContent> contents, IMapDefer defer = null);
